...
let showVideo = true;
let questionArr = [{
  question: "כמה סרטנים התאחדו כדי לעזור לסרטן היחיד?",
  option1: "32",
  option2: "16",
  option3: "18",
  correctAns: "option2",
  ...
  question: "כמה קרחונים יש בסרטון?",
  option1: "1",
  option2: "2",
  option3: "3",
  correctAns: "option3",
...
const checkAnswer = (event) => {
  ...
  if (currAns === questionArr[questionNum].correctAns) {
    ...
    setTimeout(() => {
      ...
      document.getElementById(`underDoor${questionNum + 1}`).style.display = "block";
